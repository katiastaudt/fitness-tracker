...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainItems.add(new MainItem(1, R.drawable.ic_sharp_ac_unit_24, R.string.label_imc, Color.GRAY));
        mainItems.add(new MainItem(2, R.drawable.ic_baseline_light_mode_24, R.string.label_tmb, Color.YELLOW));
